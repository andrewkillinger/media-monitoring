// Demo data for the Media Monitor UI
...
export const demoArticles: DemoArticle[] = [
  ...
  {
    id: "f014", title: "MedCorp Pharmaceuticals reports strong Q1 2025 results with DOPAVAIL uptake exceeding expectations",
    summary: "MedCorp\u2019s Q1 revenue of $247M beat consensus estimates by 8%, driven primarily by accelerating DOPAVAIL prescriptions among newly diagnosed Rett syndrome patients. Management raised full-year guidance.",
    outlet: "X / Twitter", section: "Corporate & Product News", subsection: null, date: "2025-04-15", status: "published", channel: "social", region: "US", language: "en", url: "#demo", priority: 40, entities: ["MedCorp Pharmaceuticals", "DOPAVAIL"], sentiment: "positive", isDemoUrl: true,
  ...
  {
    id: "f016", title: "Patient groups raise concerns about NEUREX side effect reporting",
    summary: "Three patient advocacy organizations have formally requested that the FDA review post-marketing safety data for NEUREX, citing what they describe as inconsistencies in adverse event documentation. MedCorp has stated it is cooperating fully with regulators.",
    outlet: "Reuters", section: "Corporate & Product News", subsection: null, date: "2025-04-15", status: "reviewed", channel: "wire", region: "US", language: "en", url: "#demo", priority: 95, entities: ["MedCorp Pharmaceuticals", "NEUREX"], sentiment: "negative", isDemoUrl: true,
    flagType: "negative_product", flagSeverity: "high",
  },
  {
    id: "f017", title: "Inside MedCorp\u2019s Strategy for Rare Disease Dominance",
    summary: "An in-depth feature examining MedCorp\u2019s strategic pivot toward rare neurological diseases, exploring how the company\u2019s pipeline of four clinical-stage candidates positions it as a potential leader in the underserved rare disease space.",
    outlet: "The Wall Street Journal", section: "Corporate & Product News", subsection: null, date: "2025-04-14", status: "reviewed", channel: "print", region: "US", language: "en", url: "#demo", priority: 85, entities: ["MedCorp Pharmaceuticals"], sentiment: "positive", isDemoUrl: true,
    isPaywalled: true,
  },
  {
  ...
  {
    id: "f019", title: "CNBC discusses MedCorp Pharmaceuticals pipeline potential",
    summary: "CNBC analysts highlighted MedCorp\u2019s expanding pipeline during a segment on rare disease investment opportunities, noting strong DOPAVAIL growth trajectory and upcoming Phase 3 readouts for NEUREX in new indications.",
    outlet: "CNBC", section: "Corporate & Product News", subsection: null, date: "2025-04-14", status: "published", channel: "broadcast", region: "US", language: "en", url: "#demo", priority: 75, entities: ["MedCorp Pharmaceuticals", "DOPAVAIL", "NEUREX"], sentiment: "positive", isDemoUrl: true,
  },
  {
...
export const demoSections = [
  ...
  { name: "Corporate & Product News", slug: "corporate-news", active: true },
...
export const demoKpis = {
  totalItems: 142, included: 98, flagged: 7, primaryMentions: 23,
  competitorItems: 31, socialItems: 8, broadcastItems: 4, pendingReview: 12,
};

export const demoVolumeData = [
  { date: "Apr 2", total: 8, primary: 2, competitor: 3 },
  { date: "Apr 3", total: 12, primary: 1, competitor: 4 },
  { date: "Apr 4", total: 10, primary: 3, competitor: 2 },
  { date: "Apr 5", total: 6, primary: 0, competitor: 3 },
  { date: "Apr 6", total: 4, primary: 0, competitor: 1 },
  { date: "Apr 7", total: 14, primary: 2, competitor: 5 },
  { date: "Apr 8", total: 11, primary: 1, competitor: 4 },
  { date: "Apr 9", total: 9, primary: 3, competitor: 3 },
  { date: "Apr 10", total: 15, primary: 4, competitor: 6 },
  { date: "Apr 11", total: 13, primary: 2, competitor: 5 },
  { date: "Apr 12", total: 7, primary: 1, competitor: 2 },
  { date: "Apr 13", total: 5, primary: 0, competitor: 2 },
  { date: "Apr 14", total: 18, primary: 3, competitor: 7 },
  { date: "Apr 15", total: 16, primary: 5, competitor: 4 },
];
...
export const demoSectionDistribution = [
  ...
  { section: "Corporate News", count: 12 },
...
export const demoFlags = [
  { id: "fl1", articleId: "f016", title: "Negative NEUREX coverage from Reuters", headline: "Patient groups raise concerns about NEUREX side effect reporting", outlet: "Reuters", type: "negative_product", severity: "high" as const, status: "reviewing" as const, date: "2025-04-15", holdFromNewsletter: true, notes: "Patient groups raising safety concerns. Monitor for follow-up coverage." },
  ...
  { id: "fl3", articleId: "f019", title: "CNBC MedCorp pipeline discussion", headline: "CNBC discusses MedCorp Pharmaceuticals pipeline potential", outlet: "CNBC", type: "earned_media", severity: "low" as const, status: "resolved" as const, date: "2025-04-14", holdFromNewsletter: false, notes: "Positive broadcast coverage." },
  { id: "fl4", articleId: "f017", title: "WSJ MedCorp rare disease strategy", headline: "Inside MedCorp\u2019s Strategy for Rare Disease Dominance", outlet: "The Wall Street Journal", type: "earned_media", severity: "medium" as const, status: "sent" as const, date: "2025-04-14", holdFromNewsletter: false, notes: "Positive feature coverage in top-tier outlet." },
];
...
export const demoRules = [
  ...
  { id: "r2", name: "Primary Company Mention", type: "assignment", priority: 20, active: true, conditions: "Entity = Primary Company", actions: "Assign to MedCorp Corporate" },
  ...
  { id: "r8", name: "Parkinson\u2019s - Exclude Movement Only", type: "exclusion", priority: 25, active: true, conditions: "Disease = Parkinson\u2019s AND contains 'movement disorder' AND NOT primary company", actions: "Exclude" },
  { id: "r9", name: "Tier 1 Primary Company - High Priority", type: "alert", priority: 5, active: true, conditions: "Tier 1 outlet AND primary entity", actions: "Alert (high) + Set priority" },
  ...
  { id: "r12", name: "News of Interest", type: "assignment", priority: 80, active: true, conditions: "Tier 1 outlet AND NOT primary company entity", actions: "Assign to News of Interest" },
];

export const demoSourceAdapters = [
  { id: "s1", name: "Google News - Primary", type: "google_news", active: true, lastFetch: "2025-04-15T14:30:00Z", itemCount: 34, status: "ok" },
...
export const demoAuditLog = [
  ...
  { id: "al2", action: "flag.create", user: "System", resource: "Negative NEUREX coverage from Reuters", date: "2025-04-15T16:05:00Z" },
